...
namespace EntregaSprint3.Controllers
{
    public class SaidaProdutoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ProdutoId,DataSaidaProduto,QuantidadeSaidaProduto,UsuarioId,ClienteId,TipoSaidaId")] SaidaProduto saidaProduto)
        {
            if (ModelState.IsValid)
            {
                var produto = await _context.Produto.Where(p => p.Id == saidaProduto.ProdutoId).FirstOrDefaultAsync();
                produto.QuantidadeEstoque = produto.QuantidadeEstoque - saidaProduto.QuantidadeSaidaProduto;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ProdutoId,DataSaidaProduto,QuantidadeSaidaProduto,UsuarioId,ClienteId,TipoSaidaId")] SaidaProduto saidaProduto)
        {
